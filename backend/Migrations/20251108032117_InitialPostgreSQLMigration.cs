    ...
    public partial class InitialPostgreSQLMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCodeCategories", x => new { x.DiscountCodeId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_DiscountCodeCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountCodeCategories_DiscountCodes_DiscountCodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCodeProducts", x => new { x.DiscountCodeId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_DiscountCodeProducts_DiscountCodes_DiscountCodeId",
                        column: x => x.DiscountCodeId,
                        principalTable: "DiscountCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountCodeProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodeCategories_CategoryId",
                table: "DiscountCodeCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodeProducts_ProductId",
                table: "DiscountCodeProducts",
                column: "ProductId");
